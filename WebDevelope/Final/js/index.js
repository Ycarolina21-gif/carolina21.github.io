const requestURL = 'https://ycarolina21-gif.github.io/carolina21.github.io/WebDevelope/Final/Activities.json';
    ...
    for (let i = 0; i < Activity.length; i++ ) {
      ...
      h2.setAttribute('class', 'Activityname');
       ...
       Length.textContent = "Length: "  + Activity[i].Length + "miles";
        ...
        Ex.setAttribute('class', 'ActivityEx');
        Ex.textContent = Activity[i].Ex;
        carddiv.appendChild(Ex);
